<?php
/*
Original Plugin Name: WP Stack CDN
Version: 0.2
Author: Mark Jaquith
*/
...
class WP_Stack_CDN_Plugin extends WP_Stack_Plugin {
	...
	public function plugins_loaded() {
		$domain_set_up = wpsf_get_setting( wpsf_get_option_group( '../settings/settings-general.php' ), 'cdn', 'cdn-enabled' ) || ( defined( 'WP_STACK_CDN_DOMAIN' ) && WP_STACK_CDN_DOMAIN );
